...
public:
    ...
    void output(TreeNode *root, int targetSum) {
        ...
        printBT("", root, false);
        cout << "Has ";
        if(!hasPathSum(root, targetSum)) cout << "no";
        else cout << "a";
...
int main() {
    Solution s;
    TreeNode *t1 = new TreeNode(5, new TreeNode(4, new TreeNode(11, new TreeNode(7), new TreeNode(2)), nullptr), new TreeNode(8, new TreeNode(13), new TreeNode(4, nullptr, new TreeNode(1))));
    s.output(t1, 22);
